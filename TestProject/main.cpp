...
static JNativeRenderer* nativeRenderer = nullptr;
// Global variables
...
)
{
	...
	nativeRenderer = new JNativeRenderer(hWnd);
	if (!nativeRenderer->GetSetupIsDone())
	{
		JLogger::LogError(L"d3d setting up is failed");
		return 1;
	}
